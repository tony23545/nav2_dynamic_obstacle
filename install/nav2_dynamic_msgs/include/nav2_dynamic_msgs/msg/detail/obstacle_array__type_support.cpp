...
{
  new (message_memory) nav2_dynamic_msgs::msg::ObstacleArray(_init);
}

void ObstacleArray_fini_function(void * message_memory)
{
  auto typed_message = static_cast<nav2_dynamic_msgs::msg::ObstacleArray *>(message_memory);
  typed_message->~ObstacleArray();
}

size_t size_function__ObstacleArray__obstacles(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<nav2_dynamic_msgs::msg::Obstacle> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<nav2_dynamic_msgs::msg::Obstacle> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<nav2_dynamic_msgs::msg::Obstacle> *>(untyped_member);
  return &member[index];
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ObstacleArray_message_member_array[2] = {
  {
    ...
    offsetof(nav2_dynamic_msgs::msg::ObstacleArray, header),  // bytes offset in struct
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<nav2_dynamic_msgs::msg::Obstacle>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(nav2_dynamic_msgs::msg::ObstacleArray, obstacles),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ObstacleArray_message_members = {
  ...
  2,  // number of fields
  sizeof(nav2_dynamic_msgs::msg::ObstacleArray),
...
get_message_type_support_handle<nav2_dynamic_msgs::msg::ObstacleArray>()
{
  return &::nav2_dynamic_msgs::msg::rosidl_typesupport_introspection_cpp::ObstacleArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, nav2_dynamic_msgs, msg, ObstacleArray)() {
  return &::nav2_dynamic_msgs::msg::rosidl_typesupport_introspection_cpp::ObstacleArray_message_type_support_handle;
}
